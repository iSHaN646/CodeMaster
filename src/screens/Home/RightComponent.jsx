...
const RightComponent = () => {
  ...
  return (
    <StyledRightComponent>
      ...
      {folders.map((folder) => (
        <FolderCard key={folder._id}>
          <Header>
            <Heading size="small">
              <FcOpenedFolder /> {folder.FolderName}
            </Heading>
            <FolderIcons>
          ...
          <PlayGroundCards>
            {folder.subFolder.map((subf) => (
              <Card
                key={subf._id}
                onClick={() => {
                  navigate(`/playground/${folder._id}/${subf._id}`);
                }}
              >
                <CardContainer>
                  <Logo src={logo} />
                ...
                >
                  <IoTrashOutline
                    onClick={() => deleteCard(folder._id, subf._id)}
                  />
                  <BiEditAlt
                    onClick={() =>
                      openModal({
